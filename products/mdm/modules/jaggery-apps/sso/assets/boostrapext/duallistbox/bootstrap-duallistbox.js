    ...
    $.fn.bootstrapDualListbox = function(options) {
        ...
        return this.each(function() {
            ...
            var settings = $.extend( {
                ...
                infotextsel : 'Showing selected {0}',// text when all options are visible / false for no info text
            ...
            function refreshinfo()
            {
                ...
                if (all2 === 0) {
                    ...
                    elements.info2.html(formatstring(settings.infotextsel, [visible2, all2]));
                    elements.box2.removeClass("filtered");
                }
                else {
