...
var devices = {
    ...
    'select2' :"SELECT platforms.type_name as label, count(devices.id) as devices, count(devices.id)  as data from platforms, devices where devices.platform_id = platforms.id AND devices.tenant_id = ? group by type",
