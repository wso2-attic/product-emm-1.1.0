...
describe('Assign permission to group operations', function () {
    ...
    it('Test assign permission to group', function () {
        try {
            tearUp();
...
describe('Get permissions operations', function () {
    var permission_module = require('/modules/permission.js').permission;
    var db, permission, driver;
    var ctx = new Object();
    ...
    it('Test get permission', function () {
        try {
            tearUp();
