describe('sql-crud operation', function () {
    ...
    it('Complex query with advance query method', function () {
        ...
        device_1.udid = "34234";
        device_1.save();
        var results = DeviceModel.query("SELECT * FROM DEVICES WHERE udid like ?", function(complexObject, model){
            model.udid = complexObject['UDID'];
