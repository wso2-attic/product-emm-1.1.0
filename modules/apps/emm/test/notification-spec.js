describe('Notification Module',function(){
    describe('Get Android Operations - Notification Module', function() {
        ...
        it('Test getAndroidOperations for Android', function() {
            ...
            try {
                tearUp();
               // driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version, properties, created_date, status, byod, vendor, udid, push_token, mac) values ('2',  '-1234', 'admin', '1', 'APA91bEf', '4.1.2', '{\"device\":\"GT-I9100G\",\"model\":\"GT-I9100G\",\"imsi\":\"413025000690522\",\"imei\":\"358401042931186\"}', '2014-05-07 18:40:45', 'A', '1', 'samsung', '0', NULL, '92:1C:52:F3:53:52')");
