...
describe('Get Android Operations', function() {
    ...
    it('Test Get Pending operations for Android', function() {
    ...
    it('Test Get Pending operations for Android for non-existing device', function() {
        try {
            tearUp();
            driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version, properties, created_date, status, byod, vendor, udid, push_token, mac) values ('1',  '-1234', 'admin', '1', 'APA91bEf', '4.1.2', '{\"device\":\"GT-I9100G\",\"model\":\"GT-I9100G\",\"imsi\":\"413025000690522\",\"imei\":\"358401042931186\"}', '2014-05-07 18:40:45', 'A', '1', 'samsung', '0', NULL, '92:1C:52:F3:53:52')");
...
describe('Add notification operations', function() {
    var log = new Log();
    var notificationModule = require('/modules/notification.js').notification;
    var db, notification, driver;
    var ctx = new Object();
    ...
    it('Test Add notification', function() {
         try {
            tearUp();
            ctx.msgID = '1';
            ctx.data = 'Received';
            driver.query("insert into devices(id, tenant_id, user_id, platform_id, reg_id, os_version, properties, created_date, status, byod, vendor, udid, push_token, mac) values ('1',  '-1234', 'user', '1', 'APA91bEf', '4.1.2', '{\"device\":\"GT-I9100G\",\"model\":\"GT-I9100G\",\"imsi\":\"413025000690522\",\"imei\":\"358401042931186\"}', '2014-05-07 18:40:45', 'A', '1', 'samsung', '0', NULL, '92:1C:52:F3:53:52')");
            driver.query("insert into notifications(id, group_id, user_id, device_id, message, status, sent_date, feature_code, feature_description, tenant_id) values ('1', '-1', 'admin@admin.com', '1', '\"hi\"', 'P', '2014-05-07 18:10:46', '500A', 'Device Information', '-1234')");
    ...
    it('Test Add notification on non existing notification', function() {
        try {
            tearUp();
            ctx.msgID = '4';
            ctx.data = 'Received';
...
describe('Get notification operations', function() {
    var log = new Log();
    var notificationModule = require('/modules/notification.js').notification;
    var db, notification, driver;
    var ctx = new Object();
    ...
    it('Test Get notifications', function() {
        try {
            tearUp();
            ctx.deviceid = '1';
            driver.query("insert into notifications(id, group_id, user_id, device_id, message, status, sent_date, feature_code, feature_description, tenant_id) values ('1', '-1', 'admin@admin.com', '1', '\"hi\"', 'P', '2014-05-07 18:10:46', '500A', 'Device Information', '-1234')");
    ...
    it('Test Get notification on non existing device', function() {
        try {
            tearUp();
            ctx.deviceid = '2';
            driver.query("insert into notifications(id, group_id, user_id, device_id, message, status, sent_date, feature_code, feature_description, tenant_id) values ('1', '-1', 'admin@admin.com', '1', '\"hi\"', 'P', '2014-05-07 18:10:46', '500A', 'Device Information', '-1234')");
...
describe('Get last record operations', function() {
    var log = new Log();
    var notificationModule = require('/modules/notification.js').notification;
    var db, notification, driver;
    var ctx = new Object();
    ...
    it('Test Get last record', function() {
        try {
            tearUp();
            ctx.deviceid = '1';
            ctx.operation = '502A';
    ...
    it('Test Get last record on non-existing device', function() {
        try {
            tearUp();
            ctx.deviceid = '2';
            ctx.operation = '502A';
    ...
    it('Test Get last record on non-existing feature', function() {
        try {
            tearUp();
            ctx.deviceid = '1';
            ctx.operation = '501P';
    ...
    it('Test Get last record on ios device', function() {
        try {
            tearUp();
            ctx.deviceid = '1';
            ctx.operation = '500A';
