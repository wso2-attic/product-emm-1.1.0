...
CREATE TABLE devices(ID INT PRIMARY KEY auto_increment, TENANT_ID INT, USER_ID VARCHAR(128), PLATFORM_ID INT, UDID VARCHAR(4096), OS_VERSION VARCHAR(64), OWNERSHIP VARCHAR(8), challenge_token VARCHAR(48), TOKEN TEXT, MAC_ADDRESS VARCHAR(256), STATUS VARCHAR(1), CREATED_DATE DATETIME, MODIFIED_DATE DATETIME);
