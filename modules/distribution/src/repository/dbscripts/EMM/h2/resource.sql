...
CREATE TABLE device_policy(ID INT PRIMARY KEY auto_increment, TENANT_ID INT, DEVICE_ID INT, POLICY_ID INT, POLICY_CATEGORY_ID INT, FILTERED_PAYLOAD TEXT, RESULT_PAYLOAD TEXT, STATUS VARCHAR(1), DATETIME DATETIME);
...
CREATE TABLE device_info(ID INT PRIMARY KEY auto_increment, DEVICE_ID INT, TENANT_ID INT, USER_ID VARCHAR(128), EOM INT, FEATURE_CODE VARCHAR(8), SENT_MESSAGE TEXT, RECEIVED_MESSAGE TEXT, STATUS VARCHAR(1), SENT_DATE DATETIME, RECEIVED_DATE DATETIME);
