...
CREATE TABLE platform_features(ID INT PRIMARY KEY auto_increment, PLATFORM_ID INT, FEATURE_ID INT, MIN_OS VARCHAR(8), MAX_OS VARCHAR(8), CLOUD VARCHAR(8), UI_TEMPLATE VARCHAR(32));
...
CREATE TABLE devices(ID INT PRIMARY KEY auto_increment, TENANT_ID INT, USER_ID VARCHAR(128), PLATFORM_ID INT, UDID VARCHAR(4096), OS_VERSION VARCHAR(64), OWNERSHIP VARCHAR(8), MAC_ADDRESS VARCHAR(256), STATUS VARCHAR(1), CREATED_DATE DATETIME, MODIFIED_DATE DATETIME);

DROP TABLE IF EXISTS devices_detail;
CREATE TABLE devices_detail(ID INT, SEQ_ID INT, TOKEN VARCHAR(2048));

DROP TABLE IF EXISTS policies;
CREATE TABLE policies(ID INT PRIMARY KEY auto_increment, TENANT_ID INT, NAME VARCHAR(32), TYPE VARCHAR(1), STATUS VARCHAR(1), CREATED_DATE DATETIME, MODIFIED_DATE DATETIME);
...
CREATE TABLE device_policy(ID INT PRIMARY KEY auto_increment, TENANT_ID INT, DEVICE_ID INT, POLICY_ID INT, POLICY_CATEGORY_ID INT, STATUS VARCHAR(1), DATETIME DATETIME);

DROP TABLE IF EXISTS device_policy_detail;
CREATE TABLE device_policy_detail(ID INT, SEQ_ID INT, FILTERED_PAYLOAD VARCHAR(2048), RESULT_PAYLOAD VARCHAR(2048));
...
CREATE TABLE device_info(ID INT PRIMARY KEY auto_increment, DEVICE_ID INT, TENANT_ID INT, USER_ID VARCHAR(128), EOM INT, FEATURE_CODE VARCHAR(8), STATUS VARCHAR(1), SENT_DATE DATETIME, RECEIVED_DATE DATETIME);
